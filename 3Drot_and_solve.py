...
plt.plot(np.full(N, D_roll), color='black', linestyle='dashed')
plt.xlabel('frame')
...
plt.plot(np.full(N, D_pitch), color='black', linestyle='dashed')
plt.xlabel('frame')
plt.ylabel('angle (deg)')
plt.title('Pitch')
#yaw
...
plt.plot(np.full(N, D_yaw), color='black', linestyle='dashed')
plt.xlabel('frame')
plt.ylabel('angle (deg)')
plt.title('Yaw')
# save and show
